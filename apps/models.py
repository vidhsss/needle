...
#         self.device = device
#         self.dtype = dtype
#         self.ConvBN1= self.ConvBN(3, 16, 7, 4)
#         self.ConvBN2= self.ConvBN(16, 32, 3, 2)
#         self.ConvBN3=self.ConvBN(32,32,3,1)
#         self.ConvBN4=self.ConvBN(32,64,3,2)
#         self.ConvBN5=self.ConvBN(32,128,3,2)
#         self.ConvBN6=self.ConvBN(128,128,3,1)
#         self.flatten=nn.Flatten()
#         self.linear1=nn.Linear(128, 128, device = self.device, dtype = self.dtype)
#         self.relu=nn.ReLU()
